...
```{r}
# why is the file path not working? 
# ncha_demo <- read_xlsx("Onramp/Data/NCHA2021_RWS_Subset.xlsx", col_names = TRUE)

ncha_demo <- read_xlsx("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/SFSU Faculty/PINC 2025/PSP2025/Onramp/Data/NCHA2021_RWS_Subset.xlsx", col_names = TRUE)

# ncha_demo <- read_excel("Onramp/Data/NCHA2021_RWS_Subset.xlsx")
...
```{r}
write.csv(ncha_new, "~/Library/Mobile Documents/com~apple~CloudDocs/Documents/SFSU Faculty/PINC 2025/PSP2025/Onramp/Data/ncha_new.csv")
```
